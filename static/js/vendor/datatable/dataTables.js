...
(function( factory ) {
	...
	$.extend( DataTable.ext.classes, {
		...
		info: {
			container: 'dt-info text-sm font-normal text-gray-500 dark:text-gray-400'
		},
		length: {
			container: 'dt-length',
			select: 'dt-input'
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 */
			"sInfo": `Showing<span class="font-semibold text-gray-900 dark:text-white"> _START_-_END_ </span>of<span class="font-semibold text-gray-900 dark:text-white"> _TOTAL_ </span>_ENTRIES-TOTAL_`,
	...
	$.extend( DataTable.ext.classes, {
		...
		length: {
			container: 'dt-length text-sm font-normal text-gray-500 dark:text-gray-400',
			select: 'dt-input'
		},
		order: {
			canAsc: 'dt-orderable-asc',
		...
		search: {
			container: 'dt-search text-sm font-normal text-gray-500 dark:text-gray-400',
			input: 'dt-input'
		},
		table: 'dataTable',	
		tbody: {
	...
	DataTable.feature.register( 'search', function ( settings, opts ) {
		...
		<div class="relative w-full">
			...
			<input type="search" class="`+classes.input+`"/>
		</div>`;
